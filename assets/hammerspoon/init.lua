...
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "1", widel)
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "2", wideml)
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "3", widem)
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "4", widemr)
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "5", wider)
